...
import { Produto, TipoProduto } from 'models';
...
export class EditarProdutoDialogComponent {
  ...
  private ref     = inject(MatDialogRef<EditarProdutoDialogComponent>);
  private produto = inject<Produto>(MAT_DIALOG_DATA);
  ...
  salvar(): void {
    ...
    this.catalog.atualizar(this.produto.id, {
      nome,
      tipo,
      preco,
